...
module.exports.bootstrap = async function () {
    ...
    const kategorienDaten = [
      {
        name: "Shonen",
        beschreibung:
          "Actionreiche Manga für ein jüngeres männliches Publikum, mit Freundschaft, Kampf und Abenteuer.",
      },
      {
        name: "Seinen",
        beschreibung:
          "Erwachsenere Geschichten mit ernsten Themen, meist für ein älteres männliches Publikum.",
      },
      {
        name: "Shojo",
        beschreibung:
          "Romantische und gefühlvolle Geschichten, häufig mit weiblicher Hauptfigur und Fokus auf Beziehungen.",
      },
      {
        name: "Slice of Life",
        beschreibung:
          "Alltagsgeschichten über Schule, Arbeit oder Freundschaft – ruhig, emotional und realistisch.",
      },
      {
        name: "Thriller",
        beschreibung:
          "Spannende Manga mit Nervenkitzel, oft mit Krimi- oder Mystery-Elementen.",
      },
      {
        name: "Action",
        beschreibung:
          "Manga mit viel Bewegung, Kämpfen und spektakulären Szenen – Spannung pur.",
      },
    ];
    await Kategorie.createEach(kategorienDaten);
    sails.log.info(
      "📚 Standard-Kategorien mit Beschreibungen wurden erstellt.",
    );
  } else {
  ...
  if (produktCount === 0) {
    ...
    if (kategorien.length === 0) {
      sails.log.error(
        "❌ Keine Kategorien gefunden – Produkte können nicht erstellt werden.",
      );
      return;
    }
    ...
    const produkte = [
      {
        ...
        beschreibung:
          "Monkey D. Ruffy will König der Piraten werden. Der Auftakt zur legendären Reise!",
        preis: 6.99,
        kategorie: "Shonen",
        quantity: 100,
      ...
      },
      {
        ...
        beschreibung:
          "Menschen gegen Titanen – eine epische Schlacht um Freiheit beginnt.",
        preis: 7.99,
        kategorie: "Seinen",
        quantity: 80,
      ...
      },
      {
        titel: "Naruto Vol. 1",
        beschreibung:
          "Ein junger Ninja mit einem Traum: Hokage werden und anerkannt sein.",
        preis: 6.5,
        kategorie: "Shonen",
        quantity: 90,
      ...
      },
      {
        ...
        beschreibung:
          "Ein Schüler findet ein Notizbuch, das töten kann – das Spiel beginnt.",
        preis: 8.5,
        kategorie: "Thriller",
        quantity: 70,
      ...
      },
      {
        ...
        beschreibung:
          "Tanjiro kämpft gegen Dämonen, um seine Schwester zu retten.",
        preis: 7.5,
        kategorie: "Action",
        quantity: 60,
      ...
      },
      {
        ...
        beschreibung:
          "In einer Welt voller Superkräfte kämpft Izuku für Gerechtigkeit.",
        preis: 6.75,
        kategorie: "Shonen",
        quantity: 100,
      ...
      },
      {
        ...
        beschreibung:
          "Ein Student wird zum Halb-Ghoul und muss in einer dunklen Welt überleben.",
        preis: 8.25,
        kategorie: "Seinen",
        quantity: 50,
      ...
      },
      {
        ...
        beschreibung:
          "Ein Teufelsjäger mit einer Motorsäge als Herz kämpft ums Überleben.",
        preis: 7.8,
        kategorie: "Action",
        quantity: 75,
    ...
    for (const p of produkte) {
      ...
      if (!kategorieObjekt) {
        sails.log.warn(
          `⚠️ Kategorie ${p.kategorie} nicht gefunden – Produkt "${p.titel}" wird übersprungen.`,
        );
        continue;
      }
    ...
    await Blog.createEach([
      {
        ...
        inhalt:
          "Endlich bei uns erhältlich: Die Abenteuer von Ruffy, dem angehenden Piratenkönig. Jetzt stöbern!",
        aktiv: true,
      ...
      },
      {
        ...
        inhalt:
          "Tanjiros Kampf gegen Dämonen begeistert die Manga-Community. Jetzt Band 1 bis 5 erhältlich.",
        aktiv: true,
      ...
      },
      {
        ...
        inhalt:
          "Du findest ab sofort auch Thriller und Slice of Life! Entdecke neue Lieblingsgenres.",
        aktiv: true,
